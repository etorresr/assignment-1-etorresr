...
int Test_validate_username_main(void)
{
  UnityBegin("/home/emmanuel-torres/Documents/cursera/linux_embed/assignment-1-etorresr/assignment-autotest/../student-test/assignment1/Test_validate_username.c");
